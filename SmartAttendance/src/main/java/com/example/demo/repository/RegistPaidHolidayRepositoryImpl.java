...
public class RegistPaidHolidayRepositoryImpl implements RegistPaidHolidayRepository {
	...
	String sql_remainingDays_paid = "select paidHolidays_left from pto_info where emp_id = ?";
	...
	public int remainingDays(String emp_id) {
		int result = jdbcTemplate.queryForObject(sql_remainingDays_paid, Integer.class, emp_id);
		return result;
	}
}
